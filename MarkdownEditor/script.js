let textAreaEditor = document.getElementById("textAreaEditor");
let textAreaViewer = document.getElementById("textAreaViewer");
...
function update() {
    let rawText = textAreaEditor.innerHTML;
    ...
    textAreaViewer.innerHTML = rawText;
}
...
function switchMode() {
    update();
    if (textAreaViewer.style.visibility == "hidden") {
        textAreaEditor.style.visibility = "hidden";
        textAreaViewer.style.visibility = "unset";
        document.getElementById("modeButton").innerHTML = "View Mode";
    }
    else {
        textAreaViewer.style.visibility = "hidden";
        textAreaEditor.style.visibility = "unset";
        document.getElementById("modeButton").innerHTML = "Edit Mode";
    }
}
